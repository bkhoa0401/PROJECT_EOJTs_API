...
const routes = [
  ...
  { path: '/supervisor', exact: true, name: 'Supervisor', component: SiteSupervisor },
  ...
  { path: '/manage_account', exact: true, name: 'Danh sách tài khoản Supervisor', component: ManageAccount },
  ...
  { path: '/informmessage', exact: true, name: 'Thông báo', component: InformMessage },
  ...
  { path: '/report', exact: true, name: 'Đánh giá', component: Report },
